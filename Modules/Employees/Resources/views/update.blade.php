...
<div class="row justify-content-center">
	<div class="col-md-6">
	  <h5 class="text-left mt-4 mb-4"><b>Edit</b></h5>
	  <form id="needs-validation" class="form-update" action="{{url('dashboard/employees/update-employees')}}" novalidate>
	    {!! csrf_field() !!}
	    {{ method_field('PATCH') }}

      <div class="form-group">
        <label>First Name</label>
        <input id="update_first_name" type="text" name="first_name" class="form-control" placeholder="Input First Name">
      </div>

      <div class="form-group">
        <label>Last Name</label>
        <input id="update_last_name" type="text" name="last_name" class="form-control" placeholder="Input Last Name">
      </div>

      <div class="form-group">
        <label>Company</label>
        <select id="update_company_id" class="form-control select2-companies" name="company_id" style="width: 100%;">
      ...
      <div class="form-group">
        <label>Phone</label>
        <input id="update_phone" type="text" name="phone" class="form-control" placeholder="Input Phone">
      </div>


      <div class="form-group">
        <label>Email</label>
        <input id="update_email" type="email" name="email" class="form-control" placeholder="Input Email">
      </div>

	    <div class="form-group text-right">
	      <button id="update_submit" type="submit" class="btn btn-info rounded">Perbarui</button>
	    </div>
	  </form>
	</div>
</div>