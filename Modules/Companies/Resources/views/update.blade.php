...
<div class="row justify-content-center">
	<div class="col-md-6">
	  ...
	  <form id="needs-validation" class="form-update" action="{{url('dashboard/companies/update-companies')}}" novalidate>
	    {!! csrf_field() !!}
	    {{ method_field('PATCH') }}

			<div class="form-group">
        <label>Text</label>
        <input id="update_name" type="text" name="name" class="form-control" placeholder="Input Name">
      </div>
        ...
        <label>Website</label>
          ...
          <input id="update_website" type="text" name="website" class="form-control" placeholder="Input Website">
        </div>
      </div>

      <div class="form-group">
        <div class="custom-file-container" data-upload-id="update_logo">
